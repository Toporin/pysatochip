...
# v 0.1: initial version
# v 0.2: support P2PK proofs (NUT11) with BIP32 key derivation
SATOCASH_PROTOCOL_MAJOR_VERSION=0
SATOCASH_PROTOCOL_MINOR_VERSION=2
...
# v0.17.4: feat: add pycryptodomex fallback for certificate-chain / authenticity validation
